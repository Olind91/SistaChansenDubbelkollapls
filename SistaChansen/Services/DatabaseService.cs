using SistaChansen.Contexts;
using SistaChansen.Models.Entities;
using SistaChansen.Models;
using System;
...
namespace SistaChansen.Services
{
    internal class DatabaseService
    {
        ...
        {
            var ticketEntity = await _context.Ticket.FirstOrDefaultAsync(x => x.Customer.CustomerEmail == email);
            if (ticketEntity != null)
            {
